function [accuracy1,accuracy2] = main_func2(data_process_method,gamma,c,func)
...
[D,mylda,W]=lda(f_matrix,RealClassTrain,k);%主成分分析法特征提取  
   
multiSVMstruct=svm_train(mylda,npersons,gamma,c,func);  
...
testface2 = cal_latent('lda',testface,W);
